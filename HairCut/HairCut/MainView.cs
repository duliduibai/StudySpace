...
namespace HairCut
{
    ...
    public partial class MainView : Form
    {
        ...
        {
            if (!(SELECTED_CONTROL == LastSelectContol.CASHINLIST))
                return;
            subCtlCashInList.OpenEx();
        }
        ...
        private void btnNewVIP_Click(object sender, EventArgs e)
        {
            frmNewVIP frm = new frmNewVIP();
            frm.ShowDialog();
        }
    }
}
